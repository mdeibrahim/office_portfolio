...
export default function Hero() {
    return (
        ...
        <div className="w-full min-h-screen relative overflow-hidden bg-[#0A29FF] px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
            ...
            <div className="relative z-20 min-h-screen flex items-center justify-center py-8 sm:py-12">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="inline-flex items-center mt-0 gap-2 px-4 py-1.5 sm:px-5 sm:py-2 rounded-full border border-violet-500/20 bg-linear-to-r from-violet-500/10 via-cyan-500/10 to-pink-500/10 backdrop-blur-md text-white text-xs sm:text-sm font-medium animate-bounce">
                        🚀
                        <span className="bg-linear-to-r from-violet-400 via-cyan-400 to-pink-400 bg-sixe-200%_200% bg-clip-text text-transparent animate-gradient">
                    ...
                    <h1 className="mt-6 font-extrabold leading-[1.1] tracking-tight text-white text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-8xl">
                        Share Your Idea
                        <br />
                        <span className="bg-linear-to-r from-violet-400 via-indigo-400 to-cyan-400 bg-sixe-200%_200% bg-clip-text text-transparent animate-gradient">
                            And Make It Real
                        </span>
                    </h1>

                    {/* Description - Readability size optimizations */}
                    <p className="mt-5 sm:mt-6 max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-white/60 leading-relaxed px-2 sm:px-0">
                    ...
                    <div className="mt-7 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto sm:max-w-none">
                        <a
                            href="#contact"
                        ...
                        <a
                            href="#portfolio"
                            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl border border-white/10 bg-white/5 text-white font-semibold hover:bg-white/10 active:scale-95 transition-all text-sm sm:text-base backdrop-blur-sm"
                        >
                            <PlayCircle size={18} />
                            View Our Work
                        </a>
                    ...
                    <div className="mt-14 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8 md:gap-8 max-w-4xl mx-auto border-t border-white/5 pt-8 sm:pt-10">
                        <div>
